...
namespace CreditContolTrackerAPIs.Migrations
{
    ...
    [Migration("20230619091211_ChangedDataTypeLongToDouble")]
    partial class ChangedDataTypeLongToDouble
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CreditContolTrackerAPIs.Models.AnalyticReport", b =>
                {
                    ...
                    b.ToTable("AnalyticReports");
                });

            modelBuilder.Entity("CreditContolTrackerAPIs.Models.Prediction", b =>
                {
                    b.Property<string>("InvoiceNo")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CreditContolTrackerAPIs.Models.TotalAnalysis", b =>
                {
                    b.Property<int>("pending_invoices")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("pending_invoices"));

                    b.Property<int>("late_Paid_invoices")
                        .HasColumnType("int");

                    b.Property<int>("paid_invoices")
                        .HasColumnType("int");

                    b.Property<decimal>("pending_revenue")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("percentageOfPendingInvoices")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("percentageOfRevenueOnHold")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("total_Revenue")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("total_invoices")
                        .HasColumnType("int");

                    b.HasKey("pending_invoices");

                    b.ToTable("TotalAnalysis");
                });
            ...
            modelBuilder.Entity("CreditControlTrackerAPIs.Models.InvoiceDetail", b =>
                {
                    ...
                    b.Property<double?>("BalanceInCurrency")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("CreditNoteDiscounts")
                        .HasColumnType("float");

                    b.Property<double?>("CreditUsdamount")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("FusionAccountNumber")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("CreditControlTrackerAPIs.Models.Receipt", b =>
                {
                    ...
                    b.Property<double?>("RecOrigCurrAmount")
                        .HasColumnType("float");
